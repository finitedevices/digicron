...
function findWasmBinary() {
  return locateFile('digicron.wasm');
}
...
function send_display_data_to_simulator(dataPtr,size) { renderDisplayData(new Uint8ClampedArray(HEAPU8.buffer.slice(dataPtr), 0, size)); }
...
var wasmImports = {
  ...
  fd_write: _fd_write,
  /** @export */
  send_display_data_to_simulator
};
